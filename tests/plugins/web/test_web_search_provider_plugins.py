...
- All nine bundled plugins (brave-free, ddgs, searxng, exa, gemini, parallel,
...
class TestErrorResponseShapes:
    ...
    def test_gemini_search_returns_error_dict_when_unconfigured(self) -> None:
        """Gemini returns a typed error dict (no GEMINI_API_KEY)."""
        _ensure_plugins_loaded()
        from agent.web_search_registry import get_provider
